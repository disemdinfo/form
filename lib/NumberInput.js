...
var NumberInput = function NumberInput(_ref) {
  var label = _ref.label,
      ...
      prefix = _ref.prefix,
      suffix = _ref.suffix,
      inputProps = _objectWithoutProperties(_ref, ['label', 'onChange', 'value', 'prefix', 'suffix']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactCurrencyInput2.default, _extends({}, inputProps, {
      ...
      onBlur: function (_onBlur) {
        ...
        return onBlur({ e: e, id: e.target.id, value: Number(e.target.value.replace(/\./g, '').replace(',', '.').replace(prefix, '').replace(suffix, '')) });
      }),
