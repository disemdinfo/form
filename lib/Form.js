...
var InputContainer = function InputContainer(_ref) {
  var children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ['children', 'error', 'hideError']);

  return _react2.default.createElement(
    'div',
    { error: error, className: 'input-container' + error ? ' input-error' : '' },
    children,
  ...
  _createClass(Form, [{
    ...
    value: function getInputs(children) {
      ...
      if (!isObject(children)) {
        ...
        return _react2.default.createElement(
          InputContainer,
          _extends({}, children.props, { error: getError(children.props), hideError: this.props.hideError }),
          children
        );
      } else {
        return children;
