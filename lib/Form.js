...
var Input = function Input(_ref) {
  var children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ['children', 'id', 'error', 'info', 'inputStyle', 'inputWidth', 'submited']);

  return _react2.default.createElement(
    'div',
    { error: error, style: _extends({ width: inputWidth || '100%' }, inputStyle), className: 'input-container ' + (error ? 'input-error' : '') },
    children,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          actions.filter(function (a) {
            ...
            return _react2.default.createElement(_Button2.default, _extends({}, actionProps, { key: id }));
          })
        )
      );
    }
