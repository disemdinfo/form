...
var SelectSearch = function (_PureComponent) {
  _inherits(SelectSearch, _PureComponent);

  function SelectSearch(props) {
    _classCallCheck(this, SelectSearch);

    var _this = _possibleConstructorReturn(this, (SelectSearch.__proto__ || Object.getPrototypeOf(SelectSearch)).call(this, props));
  ...
  _createClass(SelectSearch, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style,
          inputProps = _objectWithoutProperties(_props, ['isMulti', 'value', 'getOptions', 'onChange', 'id', 'optionValue', 'optionLabel', 'labelRenderer', 'style']);

      return _react2.default.createElement(_async2.default, _extends({}, inputProps, {
