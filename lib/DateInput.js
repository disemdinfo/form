...
var DateInput = function DateInput(_ref) {
  var _onChange = _ref.onChange,
      ...
      inputProps = _objectWithoutProperties(_ref, ['onChange', 'id', 'value', 'closeOnSelect', 'timeFormat', 'isValidDate', 'minDate', 'maxDate']);
  ...
  return _react2.default.createElement(_reactDatetime2.default, {
    ...
    inputProps: _extends({ className: 'input' }, inputProps)
  });
};
